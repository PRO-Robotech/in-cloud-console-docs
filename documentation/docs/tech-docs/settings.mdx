...
<table>
  ...
  <tbody>
    ...
    <tr>
      <td><code>spec.additionalPrinterColumnsDisableSortersAndFilters[]</code></td>
      <td>array</td>
      <td>
        <YamlModal
          yamlContent={dedent`
...
<dt><code>spec.additionalPrinterColumnsDisableSortersAndFilters[]</code></dt>
<dd>Правила отключения сортировок и фильтров на колонке таблицы.</dd>
</dl>
