...
<p>
  ...
  ссылку, в которых могут использоваться плейсхолдеры (<code>\{clusterName}</code>, <code>\{namespace}</code>,{' '}
  <code>\{apiGroup}</code>, <code>\{apiVersion}</code>, <code>\{typeName}</code>). Это позволяет гибко настраивать
...
<ul>
  ...
  <li>
    <code>[".metadata.name"]</code> — путь к&nbsp; нужному полю
  </li>
  <li>
...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>OwnerRef с ссылкой на фабрику</td>
      <td>
        <figure style={{ textAlign: 'center', display: 'contents' }}>
          {/* <FancyboxImage src={`${getBasePrefix()}img/in-cloud/components/NodeTerminal.drawio.svg`} style={{ width: '100%', maxWidth: 'none' }} /> */}
          <figcaption style={{ marginTop: '0.5rem', fontSize: '0.9rem', color: '#666', textAlign: 'center' }}>
    ...
    <tr>
      ...
      <td>Компонент переключения состояния</td>
      <td>
        <figure style={{ textAlign: 'center', display: 'contents' }}>
          {/* <FancyboxImage src={`${getBasePrefix()}img/in-cloud/components/NodeTerminal.drawio.svg`} style={{ width: '100%', maxWidth: 'none' }} /> */}
          <figcaption style={{ marginTop: '0.5rem', fontSize: '0.9rem', color: '#666', textAlign: 'center' }}>
    ...
    <tr>
      ...
      <td>Компонент переключения состояния из множества возможных</td>
      <td>
        <figure style={{ textAlign: 'center', display: 'contents' }}>
          {/* <FancyboxImage src={`${getBasePrefix()}img/in-cloud/components/NodeTerminal.drawio.svg`} style={{ width: '100%', maxWidth: 'none' }} /> */}
          <figcaption style={{ marginTop: '0.5rem', fontSize: '0.9rem', color: '#666', textAlign: 'center' }}>
