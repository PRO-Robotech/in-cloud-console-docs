...
> На&nbsp;этом этапе вы устанавливаете основное приложение. Возможна настройка как&nbsp;базового варианта, так&nbsp;и&nbsp;полноценной версии «под&nbsp;ключ» — с&nbsp;oAuth-Proxy и&nbsp;Dex. Здесь также добавляется интерфейсная надстройка — готовый пресет, с&nbsp;которого удобно начать знакомство с&nbsp;системой.
