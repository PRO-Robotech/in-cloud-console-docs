...
Для быстрого старта вы можете использовать `port-forward`:
...
:::warning
Если вы запускаете UI в&nbsp;ознакомительных целях, без&nbsp;интеграции с&nbsp;IDP (централизованной аутентификацией), потребуется назначить базовую роль для&nbsp;анонимного пользователя:
